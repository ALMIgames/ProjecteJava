...
/******************************************************************************/
            case "proveidors":
                try{
                    ...
                    for (int i = 0; i < xmlP.length(); i++) //Escrivim els objectes al fitxer
                        {
                            sortida.write(xmlP);
                        }
...
/******************************************************************************/
            case "clients":
                try{
                    ...
                    for (int i = 0; i < xmlC.length(); i++) //Escrivim els objectes al fitxer
                        {
                            sortida.write(xmlC);
                        }
...
/******************************************************************************/
            case "articles":
                try{
                    ...
                    for (int i = 0; i < xmlA.length(); i++) //Escrivim els objectes al fitxer
                        {
                            sortida.write(xmlA);
                        }
