...
public class ComandesVendesGui extends javax.swing.JFrame {
        ...
        taulaModelCV.getSelectionModel().addListSelectionListener(new ListSelectionListener() {
            ...
            public void valueChanged(ListSelectionEvent e) {
                ...
                if(i!=-1){
                    ...
                    modDataAlta.setText(taulaModelCV.getModel().getValueAt(i, 0).toString());
                    modClient.setText(taulaModelCV.getModel().getValueAt(i, 1).toString());
                    modRef.setText(taulaModelCV.getModel().getValueAt(i, 2).toString());
                    modResponsable.setText(taulaModelCV.getModel().getValueAt(i, 3).toString());
                    modDataEntrega.setText(taulaModelCV.getModel().getValueAt(i, 4).toString());
                    modObsEntrega.setText(taulaModelCV.getModel().getValueAt(i, 5).toString());
                    modNotes.setText((String)taulaModelCV.getModel().getValueAt(i, 6).toString());
                    modImportPreDesc.setText((String)taulaModelCV.getModel().getValueAt(i, 7).toString());
                    modDescompte.setText(taulaModelCV.getModel().getValueAt(i, 8).toString()); 
                    modImportBrut.setText(taulaModelCV.getModel().getValueAt(i, 9).toString()); 
                    modImportNet.setText((String)taulaModelCV.getModel().getValueAt(i, 10).toString());                          
    ...
    private void initComponents() {
        ...
        btn_detallComanda2 = new javax.swing.JButton();
        ...
        btn_detallComanda = new javax.swing.JButton();
        ...
        taulaModelCV.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Data Alta", "Client", "Ref", "Responsable", "Data Entrega", "Notes Entrega", "Notes", "Import Inicial", "Descompte", "Import Brut", "Imort Net", "Index"
            }
        ) {
            Class[] types = new Class [] {
                java.lang.Integer.class, java.lang.String.class, java.lang.Object.class, java.lang.String.class, java.lang.String.class, java.lang.String.class, java.lang.String.class, java.lang.String.class, java.lang.Float.class, java.lang.Integer.class, java.lang.Float.class, java.lang.Float.class, java.lang.Integer.class
            };
        ...
        taulaModelCV.setNextFocusableComponent(modClient);
        ...
        if (taulaModelCV.getColumnModel().getColumnCount() > 0) {
            taulaModelCV.getColumnModel().getColumn(3).setPreferredWidth(8);
            taulaModelCV.getColumnModel().getColumn(4).setPreferredWidth(25);
            taulaModelCV.getColumnModel().getColumn(5).setPreferredWidth(25);
            taulaModelCV.getColumnModel().getColumn(6).setPreferredWidth(8);
            taulaModelCV.getColumnModel().getColumn(7).setPreferredWidth(10);
            taulaModelCV.getColumnModel().getColumn(8).setPreferredWidth(8);
            taulaModelCV.getColumnModel().getColumn(9).setPreferredWidth(10);
            taulaModelCV.getColumnModel().getColumn(10).setPreferredWidth(8);
            taulaModelCV.getColumnModel().getColumn(11).setPreferredWidth(8);
        }

        btn_actualitzar.setText("Modificar");
        btn_actualitzar.setNextFocusableComponent(taulaModelCV);
        ...
        modClient.setNextFocusableComponent(modRef);
        ...
        modResponsable.setNextFocusableComponent(modDescompte);
        ...
        modDataAlta.setNextFocusableComponent(modDataEntrega);
        ...
        modNotes.setRows(5);
        modNotes.setNextFocusableComponent(modImportPreDesc);
        ...
        modDescompte.setNextFocusableComponent(modObsEntrega);
        ...
        modObsEntrega.setNextFocusableComponent(modNotes);
        ...
        modImportBrut.setNextFocusableComponent(modImportNet);
        ...
        modImportPreDesc.setNextFocusableComponent(modImportBrut);
        ...
        modRef.setNextFocusableComponent(modDataAlta);
        ...
        modImportNet.setNextFocusableComponent(btn_detallComanda2);
        ...
        btn_detallComanda2.setText("Detall comanda");
        btn_detallComanda2.setNextFocusableComponent(btn_actualitzar);
        btn_detallComanda2.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btn_detallComanda2ActionPerformed(evt);
            }
        });

        modDataEntrega.setBackground(new java.awt.Color(204, 255, 255));
        modDataEntrega.setNextFocusableComponent(modResponsable);
            ...
            .addGroup(panel_modificarLayout.createSequentialGroup()
                ...
                .addGroup(panel_modificarLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addGroup(panel_modificarLayout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(btn_detallComanda2, javax.swing.GroupLayout.PREFERRED_SIZE, 159, javax.swing.GroupLayout.PREFERRED_SIZE)
                    ...
                    .addGroup(panel_modificarLayout.createSequentialGroup()
                        .addGroup(panel_modificarLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            .addComponent(jTextField17, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 98, Short.MAX_VALUE)
                        ...
                        .addGroup(panel_modificarLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, panel_modificarLayout.createSequentialGroup()
                                .addComponent(modClient, javax.swing.GroupLayout.PREFERRED_SIZE, 310, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(jTextField33, javax.swing.GroupLayout.PREFERRED_SIZE, 70, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(modRef, javax.swing.GroupLayout.PREFERRED_SIZE, 233, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(panel_modificarLayout.createSequentialGroup()
                                .addGroup(panel_modificarLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addGroup(panel_modificarLayout.createSequentialGroup()
                                        .addComponent(modDataAlta, javax.swing.GroupLayout.PREFERRED_SIZE, 69, javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                        .addComponent(jTextField14, javax.swing.GroupLayout.PREFERRED_SIZE, 86, javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                        .addComponent(modDataEntrega, javax.swing.GroupLayout.PREFERRED_SIZE, 69, javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                ...
                                .addGroup(panel_modificarLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addGroup(panel_modificarLayout.createSequentialGroup()
                                        .addComponent(modResponsable, javax.swing.GroupLayout.PREFERRED_SIZE, 135, javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                        .addComponent(jTextField38, javax.swing.GroupLayout.PREFERRED_SIZE, 96, javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                        .addComponent(modDescompte, javax.swing.GroupLayout.PREFERRED_SIZE, 42, javax.swing.GroupLayout.PREFERRED_SIZE))
                                    .addComponent(jScrollPane8, javax.swing.GroupLayout.PREFERRED_SIZE, 289, javax.swing.GroupLayout.PREFERRED_SIZE))))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(panel_modificarLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addGroup(panel_modificarLayout.createSequentialGroup()
                                .addComponent(jTextField45, javax.swing.GroupLayout.PREFERRED_SIZE, 101, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(modImportNet, javax.swing.GroupLayout.DEFAULT_SIZE, 54, Short.MAX_VALUE))
                            .addGroup(panel_modificarLayout.createSequentialGroup()
                                .addGroup(panel_modificarLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addGroup(panel_modificarLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addComponent(modImportBrut, javax.swing.GroupLayout.DEFAULT_SIZE, 54, Short.MAX_VALUE)
                                    .addComponent(modImportPreDesc))))))
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, panel_modificarLayout.createSequentialGroup()
                ...
                .addGroup(panel_modificarLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(panel_modificarLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                        ...
                        .addComponent(btn_detallComanda2, javax.swing.GroupLayout.PREFERRED_SIZE, 21, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addComponent(btn_actualitzar, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 21, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGroup(panel_modificarLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(panel_modificarLayout.createSequentialGroup()
                        .addGap(6, 6, 6)
                        .addGroup(panel_modificarLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
        ...
        btn_save.setNextFocusableComponent(addClient);
        ...
        addDescompte.setNextFocusableComponent(addObsEntrega);
        ...
        addResponsable.setNextFocusableComponent(addDescompte);
        ...
        addClient.setNextFocusableComponent(addRef);
        ...
        addRef.setNextFocusableComponent(addDataEntrega);
        ...
        addObsEntrega.setNextFocusableComponent(addNotes);
        ...
        addNotes.setRows(5);
        addNotes.setNextFocusableComponent(btn_detallComanda);
        ...
        addImportPreDesc.setBackground(new java.awt.Color(255, 204, 204));
        addImportPreDesc.setNextFocusableComponent(addImportBrut);
        addImportPreDesc.setSelectionColor(new java.awt.Color(255, 153, 153));
        ...
        addImportBrut.setBackground(new java.awt.Color(255, 204, 204));
        addImportBrut.setOpaque(false);
        addImportBrut.setSelectionColor(new java.awt.Color(255, 153, 153));
        ...
        addImportNet.setBackground(new java.awt.Color(255, 204, 204));
        addImportNet.setNextFocusableComponent(btn_save);
        addImportNet.setSelectionColor(new java.awt.Color(255, 153, 153));
        ...
        btn_detallComanda.setText("Detall comanda");
        btn_detallComanda.setNextFocusableComponent(btn_save);
        btn_detallComanda.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                btn_detallComandaMouseClicked(evt);
            }
        });
        btn_detallComanda.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btn_detallComandaActionPerformed(evt);
            }
        });

        addDataEntrega.setBackground(new java.awt.Color(204, 255, 255));
        addDataEntrega.setNextFocusableComponent(addResponsable);
                ...
                .addGroup(panel_insertLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        ...
                        .addGroup(panel_insertLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(panel_insertLayout.createSequentialGroup()
                                .addGroup(panel_insertLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addGroup(panel_insertLayout.createSequentialGroup()
                                        .addComponent(addDataEntrega, javax.swing.GroupLayout.PREFERRED_SIZE, 109, javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addGap(10, 10, 10)
                                        ...
                                        .addGap(10, 10, 10)
                                        .addComponent(addDescompte, javax.swing.GroupLayout.PREFERRED_SIZE, 63, javax.swing.GroupLayout.PREFERRED_SIZE)
                            ...
                            .addGroup(panel_insertLayout.createSequentialGroup()
                                .addComponent(addClient, javax.swing.GroupLayout.PREFERRED_SIZE, 265, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(jTextField32, javax.swing.GroupLayout.PREFERRED_SIZE, 70, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(addRef, javax.swing.GroupLayout.PREFERRED_SIZE, 281, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                    ...
                    .addGroup(panel_insertLayout.createSequentialGroup()
                        .addGroup(panel_insertLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(panel_insertLayout.createSequentialGroup()
                                .addGap(594, 594, 594)
                                .addComponent(btn_detallComanda, javax.swing.GroupLayout.PREFERRED_SIZE, 154, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(panel_insertLayout.createSequentialGroup()
                                .addGap(34, 34, 34)
        ...
        panel_insertLayout.setVerticalGroup(
            ...
            .addGroup(panel_insertLayout.createSequentialGroup()
                ...
                .addGroup(panel_insertLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(btn_detallComanda, javax.swing.GroupLayout.PREFERRED_SIZE, 21, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addGroup(panel_insertLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
    ...
    private void btn_actualitzarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_actualitzarActionPerformed
        ...
        vector.get(index).set02client(modClient.getText().trim());  /*objecte*/
        vector.get(index).set03ref(modRef.getText().trim());
        vector.get(index).set04responsable(modResponsable.getText().trim());
        vector.get(index).set05dataEntrega(modDataEntrega.getText().trim());
        vector.get(index).set06obsEntrega(modObsEntrega.getText().trim());
        vector.get(index).set07notes(modNotes.getText().trim());
        vector.get(index).set08importPreDesc(Integer.parseInt(modImportPreDesc.getText().trim()));
        vector.get(index).set09descompte(Integer.parseInt(modDescompte.getText().trim()));
        vector.get(index).set10importBrut(Integer.parseInt(modImportBrut.getText().trim()));
        vector.get(index).set11importNet(Integer.parseInt(modImportNet.getText().trim()));
        
        //I ara actualitzo la taula
                
        taulaModelCV.setValueAt(vector.get(index).get01dataAlta(),taulaModelCV.getSelectedRow(), 0);
        taulaModelCV.setValueAt(vector.get(index).get02client(),taulaModelCV.getSelectedRow(), 1); /*objecte*/
        taulaModelCV.setValueAt(vector.get(index).get03ref(),taulaModelCV.getSelectedRow(), 2);
        taulaModelCV.setValueAt(vector.get(index).get04responsable(),taulaModelCV.getSelectedRow(), 3);
        taulaModelCV.setValueAt(vector.get(index).get05dataEntrega(),taulaModelCV.getSelectedRow(), 4);
        taulaModelCV.setValueAt(vector.get(index).get06obsEntrega(),taulaModelCV.getSelectedRow(), 5);
        taulaModelCV.setValueAt(vector.get(index).get07notes(),taulaModelCV.getSelectedRow(), 6);
        taulaModelCV.setValueAt(vector.get(index).get08importPreDesc(),taulaModelCV.getSelectedRow(), 7);
        taulaModelCV.setValueAt(vector.get(index).get09descompte(),taulaModelCV.getSelectedRow(), 8);
        taulaModelCV.setValueAt(vector.get(index).get10importBrut(),taulaModelCV.getSelectedRow(), 9);
        taulaModelCV.setValueAt(vector.get(index).get11importNet(),taulaModelCV.getSelectedRow(), 10);
...
//Fem visible el jpanel de modificar i inicialment desactivem el botó d'actualitzar canvis i els quadres de text
    ...
    private void btn_detallComandaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btn_detallComandaMouseClicked
        // TODO add your handling code here:
    }//GEN-LAST:event_btn_detallComandaMouseClicked

    private void btn_detallComandaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_detallComandaActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_btn_detallComandaActionPerformed

    private void btn_detallComanda2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_detallComanda2ActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_btn_detallComanda2ActionPerformed
    ...
    private javax.swing.JButton btn_detallComanda;
    private javax.swing.JButton btn_detallComanda2;
