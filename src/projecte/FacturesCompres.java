...
public class FacturesCompres {
    ...
    public FacturesCompres(int codi, String dataAlta, String responsable, String ref, Proveidors proveidor, String notes, float importTotal) {
        this.codi = codi;
