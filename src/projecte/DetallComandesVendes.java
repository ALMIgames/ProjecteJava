 ...
 * @author albert
 */
public class DetallComandesVendes {
    private int codi;
    ...
    public DetallComandesVendes(int codi, ComandesVendes comandaVenda, int unitats, Articles article, String ref, String nom, String descripcio, String acabat, int alt, int ample, int fondo, String notes, float preuProv, float importUnitatPreDesc, int descompte, float importUnitat, float importTotal) {
        this.codi = codi;
